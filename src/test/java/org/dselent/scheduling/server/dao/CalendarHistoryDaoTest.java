...
@WebAppConfiguration
public class CalendarHistoryDaoTest
{
	@Autowired
	private CalendarHistoryDao calendarHistoryDao;
	 ...
	 */
    @Test
    public void testCalendarHistoryDao() throws SQLException
    {
    	// INSERT
    	
    	CalendarHistory calendarHistory1 = new CalendarHistory();
    	calendarHistory1.setCalendarId(1);
    	calendarHistory1.setYear(2018);
    	calendarHistory1.setSemester("D");
    	calendarHistory1.setDays("MTRF");
    	calendarHistory1.setStartTime("1400");
    	calendarHistory1.setEndTime("1450");
