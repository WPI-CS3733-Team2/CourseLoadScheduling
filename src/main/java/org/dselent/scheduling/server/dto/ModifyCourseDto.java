...
public class ModifyCourseDto
{
	...
	private ModifyCourseDto(Builder builder)
	{
	...
	public boolean equals(Object obj)
	{
		...
		if (!(obj instanceof ModifyCourseDto))
		{
			return false;
		}
		ModifyCourseDto other = (ModifyCourseDto) obj;
		if (name == null)
		{
			if (other.name != null)
			{
	...
	public String toString()
	{
		...
		builder.append("ModifyCourseDto [name=");
		builder.append(name);
	...
	/**
	 * Creates builder to build {@link ModifyCourseDto}.
	...
	/**
	 * Builder to build {@link ModifyCourseDto}.
	 */
	@Generated("SparkTools")
	public static final class Builder
	{
		...
		public ModifyCourseDto build()
		{
			return new ModifyCourseDto(this);
		}
	}
}
